...
For more about LangChain tool definitions, see [Python tools](/oss/python/langchain/tools) and [TypeScript tools](/oss/javascript/langchain/tools).
...
For per-run values such as user IDs, tenant IDs, request metadata, or feature flags, use the normal LangChain runtime context patterns for tools. See [Python tools](/oss/python/langchain/tools#access-context) and [TypeScript tools](/oss/javascript/langchain/tools#access-context).

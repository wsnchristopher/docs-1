...
<Info>
The walkthrough deploys both passes (infrastructure and application) with the script-driven Helm path, which most customers should use. The Terraform-managed Helm path is covered under [Pass 2—alternative path](#pass-2-alternative-terraform-managed-helm-deploy) below.
</Info>

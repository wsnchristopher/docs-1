...
<Tabs>
  <Tab title="Python">
    ...
    async def main():
        ...
        async for project in client.projects.list(name="my-project", limit=1):
            break
  ...
  <Tab title="TypeScript">
    ...
    const project = await client.projects.list({ name: "my-project", limit: 1 }).then((page) => page.getPaginatedItems()[0]);

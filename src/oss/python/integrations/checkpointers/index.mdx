...
If you are building a new checkpointer backend, see the [checkpointer integration authoring guidance](/oss/contributing/implement-langchain#checkpointers) for the storage contract, conformance testing, and delta channel support requirements.

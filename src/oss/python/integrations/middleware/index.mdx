...
| [eager-tools](https://github.com/cloudthinker-ai/eager-tools) | Eager tool dispatch for streaming agents. Dispatches each tool call the moment its block finishes streaming instead of waiting for `message_stop`, overlapping tool execution with generation. | [`cloudthinker-ai/eager-tools`](https://github.com/cloudthinker-ai/eager-tools) |

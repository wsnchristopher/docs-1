<CodeGroup>
    ...
    async function buildRagAgent() {
      ...
      const embeddings = new OpenAIEmbeddings({ model: "openai:gpt-5.4" });
      const vectorStore = new MemoryVectorStore(embeddings);
    ...
    async function buildRagAgent() {
      ...
      const embeddings = new OpenAIEmbeddings({ model: "openrouter:anthropic/claude-sonnet-4-6" });
      const vectorStore = new MemoryVectorStore(embeddings);
    ...
    async function buildRagAgent() {
      ...
      const embeddings = new OpenAIEmbeddings({ model: "fireworks:accounts/fireworks/models/qwen3p5-397b-a17b" });
      const vectorStore = new MemoryVectorStore(embeddings);
    ...
    async function buildRagAgent() {
      ...
      const embeddings = new OpenAIEmbeddings({ model: "ollama:devstral-2" });
      const vectorStore = new MemoryVectorStore(embeddings);

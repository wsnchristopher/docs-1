<CodeGroup>
    ...
    # from langchain_chroma import Chroma
    #
    # embeddings = OpenAIEmbeddings(model="openrouter:anthropic/claude-sonnet-4-6")
    # vector_store = Chroma.from_documents(
    #     documents=all_splits,
    #     embedding=embeddings,
    #     collection_name="rag_tutorial"
    ...
    # from langchain_chroma import Chroma
    #
    # embeddings = OpenAIEmbeddings(model="fireworks:accounts/fireworks/models/qwen3p5-397b-a17b")
    # vector_store = Chroma.from_documents(
    #     documents=all_splits,
    #     embedding=embeddings,
    #     collection_name="rag_tutorial"
    ...
    # from langchain_chroma import Chroma
    #
    # embeddings = OpenAIEmbeddings(model="ollama:devstral-2")
    # vector_store = Chroma.from_documents(
    #     documents=all_splits,
    #     embedding=embeddings,
    #     collection_name="rag_tutorial"

...
For block types and provider-specific requirements, see [Multimodal messages](/oss/javascript/langchain/messages#multimodal).
...
For setup, transports, and authentication, see [Model Context Protocol (MCP)](/oss/javascript/langchain/mcp).

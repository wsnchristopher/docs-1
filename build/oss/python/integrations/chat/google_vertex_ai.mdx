...
<Info>
    **Gemini Enterprise Agent Platform vs. Gemini API**
    ...
    The Gemini Enterprise Agent Platform integration is separate from the [Google Gemini API](/oss/python/integrations/chat/google_generative_ai/). This page showcases an enterprise version of Gemini through Google Cloud Platform (GCP).
</Info>

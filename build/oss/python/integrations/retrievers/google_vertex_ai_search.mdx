...
This notebook demonstrates how to configure `Agent Search on Gemini Enterprise Agent Platform` and use the Agent Search on Gemini Enterprise Agent Platform [retriever](/oss/python/deepagents/retrieval). The Agent Search on Gemini Enterprise Agent Platform retriever encapsulates the [Python client library](https://cloud.google.com/generative-ai-app-builder/docs/libraries#client-libraries-install-python) and uses it to access the [Search Service API](https://cloud.google.com/python/docs/reference/discoveryengine/latest/google.cloud.discoveryengine_v1beta.services.search_service).

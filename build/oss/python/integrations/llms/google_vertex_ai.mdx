...
<Warning>
**You are currently on a page documenting the use of Gemini Enterprise Agent Platform text completion models. Many models available through Google Cloud are [chat completion models](/oss/python/langchain/models).**
...
The `VertexAI` class supports all [LLM](/oss/python/langchain/models) functionality.

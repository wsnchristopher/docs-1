...
See [Fault tolerance](/oss/python/langgraph/timeout-and-error-handling#timeouts) for the full timeout lifecycle, idle-timeout refresh sources, and `runtime.heartbeat()`.
...
See [Fault tolerance](/oss/python/langgraph/timeout-and-error-handling#error-handling) for compensation patterns and `Command` routing.

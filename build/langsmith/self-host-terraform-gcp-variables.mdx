...
| Variable | Default | Required | Description |
|---|---|---|---|
| `enable_langsmith_deployment` | `true` | no | Install KEDA for queue-driven autoscaling of LangSmith workers. This is the KEDA install toggle, not the LangGraph Platform Deployments feature (see `enable_deployments`). |

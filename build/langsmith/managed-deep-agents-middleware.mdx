...
For deeper hook, state, and context details, see [Python custom middleware](/oss/python/python/langchain/middleware/custom) and [TypeScript custom middleware](/oss/python/javascript/langchain/middleware/custom).
...
For examples, see [Python custom middleware](/oss/python/python/langchain/middleware/custom) and [TypeScript custom middleware](/oss/python/javascript/langchain/middleware/custom).

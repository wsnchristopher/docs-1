...
A Managed Deep Agents project starts with an agent entry and optional project folders. For the full file layout and packaging rules, see [Project layout](/langsmith/managed-deep-agents-overview#project-layout).
